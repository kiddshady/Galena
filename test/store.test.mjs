...
ok('guardar un parche no pisa el resto', parche.densidad === 'amplia' && parche.loteVariable === store.DEFAULT_SETTINGS.loteVariable);
...
ok('las claves nuevas se completan solas', 'loteVariable' in completado && completado.densidad === 'compacta');
